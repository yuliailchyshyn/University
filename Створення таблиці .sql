...
CREATE TABLE [dbo].[Замовлення](
 ...
 CONSTRAINT [PK_Замовлення] PRIMARY KEY  [Ідентифікаційний код клієнта] ASC, [Код туру] ASC)
...
CREATE TABLE [dbo].[Клієнти](
 ...
 CONSTRAINT [PK_Клієнти] PRIMARY KEY CLUSTERED [Ідентифікаційний код клієнта] ASC)
GO
...
CREATE TABLE [dbo].[Напрямки](
 ...
 CONSTRAINT [PK_Напрямки] PRIMARY KEY CLUSTERED [Код напрямку] ASC)
GO
...
CREATE TABLE [dbo].[Тури](
	...
	[Ціна туру] [money] NOT NULL,
 CONSTRAINT [PK_Тури] PRIMARY KEY CLUSTERED [Код туру] ASC)
GO
